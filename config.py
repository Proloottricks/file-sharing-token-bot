...
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://xoxova4757:GItVA872j2CBblyz@cluster0.eqxqoky.mongodb.net/mydb?retryWrites=true&w=majority&appName=Cluster0")
